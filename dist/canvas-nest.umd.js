!function (e, t) {
    ...
    (this, function () {
        ...
        var n = t(function (e, t) {
            ...
            var n = 1; t.default = function () { return "" + n++ }, e.exports = t.default
        });
        e(n);
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                t.default = function (e) {
                    ...
                    return function () {
                        ...
                        clearTimeout(n), n = setTimeout(function () { e.apply(o, r) }, t)
                    }
                },
                e.exports = t.default
        }); e(o);
        var i = t(function (e, t) {
            Object.defineProperty(t, "__esModule", { value: !0 }); t.SizeSensorId = "size-sensor-id", t.SensorStyle = "display:block;position:absolute;top:0;left:0;height:100%;width:100%;overflow:hidden;pointer-events:none;z-index:-1;opacity:0", t.SensorClassName = "size-sensor-object"
        });
        e(i);
        ...
        var r = t(function (e, t) {
            ...
            var n, r = (n = o) && n.__esModule ? n : { default: n }; t.createSensor = function (e) {
                    ...
                    element: e, bind: function (r) {
                        t || (t = function () {
                            ...
                            return t.onload = function () {
                                ...
                                t.type = "text/html", e.appendChild(t), t.data = "about:blank", t
                        }()),
        ...
        var u = t(function (e, t) {
            ...
            t.getSensor = function (e) {
                ...
                t.removeSensor = function (e) {
                    ...
                    e.element.removeAttribute(i.SizeSensorId), e.destroy(),
                        t && a[t] && delete a[t]
                }
        });
        e(u);
        ...
        e(c);
        var l = c.clear, d = c.bind, f = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || window.oRequestAnimationFrame || function (e) {
            return window.setTimeout(e, 1e3 / 60)
        },
            v = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame || window.msCancelAnimationFrame || window.oCancelAnimationFrame || window.clearTimeout, m = function (e) {
        ...
        var y = function () {
            function e(t, n) {
                ...
                key: "requestFrame", value: function (e) {
                    var t = this; this.tid = f(function () {
                        return e.call(t)
                    })
                }
            }, {
                key: "drawCanvas", value: function () {
                    var e = this, t = this.context, n = this.canvas.width, o = this.canvas.height, i = this.current, r = this.points, a = this.all; t.clearRect(0, 0, n, o); var s = void 0, u = void 0, c = void 0, l = void 0, d = void 0, f = void 0;
                    r.forEach(function (r, v) {
                        for (r.x += r.xa, r.y += r.ya, r.xa *= r.x > n || r.x < 0 ? -1 : 1, r.ya *= r.y > o || r.y < 0 ? -1 : 1, t.fillStyle = "rgba(" + e.c.pointColor + ")", t.fillRect(r.x - .5, r.y - .5, 1, 1), u = v + 1; u < a.length; u++)null !== (s = a[u]).x && null !== s.y && (l = r.x - s.x, d = r.y - s.y, (f = l * l + d * d) < s.max && (s === i && f >= s.max / 2 && (r.x -= .03 * l, r.y -= .03 * d), c = (s.max - f) / s.max, t.beginPath(),
                            t.lineWidth = c / 2, t.strokeStyle = "rgba(" + e.c.color + "," + (c + .2) + ")",
